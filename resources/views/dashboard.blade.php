...
<head>
  ...
  <title>Dashboard | Sumber Tani</title>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src=" {{ asset('/storage/app/public/' . $produk->foto_produk) }} " style="width: 100px; object-fit: cover; border-radius: 50%;"><br>{{$produk->nama_produk}}</td>
                    @else
